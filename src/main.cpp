...
uint256 hashGenesisBlock("0xd1371cbb9c9ebbc733100c170f5c04e57aef35d24e981b4a6883ed5c07e81d02");
...
if(nHeight == 1) {
   nSubsidy = 30000050 * COIN;
}

    // Subsidy is cut in half every 600000 blocks, which will occur approximately every 4 years
    nSubsidy >>= (nHeight / 600000); // Poins: 600k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 3.5 * 24 * 60 * 60; // Poins: 3.5 days
static const int64 nTargetSpacing = 5 * 60; // Poins: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xff5ca4729dd616b975fa1e46be027ee93165750640454c97733f5d012d9b5e5c");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Purwokerto 22 Juni 2018 Nandhika, POINS, 2018";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1529647728;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2085106602;

        if (fTestNet)
        {
            block.nTime    = 1529647667;
            block.nNonce   = 385366436;
        }
...
if (false && block.GetHash() != hashGenesisBlock)
        ...
        assert(block.hashMerkleRoot == uint256("0x4b5c06bffde52f50aaa589401df117e691c53131768d7071ec13089df49ebfb3"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xf2, 0xc0, 0xb1, 0xd8 }; // Poins: increase each by adding 2 to bitcoin's value.
